...
out_data_root = f"db_scan_rbm_{source_file_name[:-4]}_{date_xprmnt}"
...
def objective(trial):
    ...
    forward_window = len(df[forward_index:])
    """""" """""" """""" """""" """"" Параметры сети """ """""" """""" """""" """"""
    BATCH_SIZE = 10
    ...
    for n in range(n_iters):
        ...
        for forward_array in Forward_X:
            ...
            db_cl = DBSCAN(eps=0.3, min_samples=n_neighbors).fit(feature_set)
