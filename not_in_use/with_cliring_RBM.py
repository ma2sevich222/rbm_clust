...
for train_window, test_window in forward.run():
    ...
    train_df = df[train_window[0]: train_window[1]]
    forward_df = df[test_window[0] - (patch-1): test_window[1]]
    dates_dict['train_start'].append(str(train_df.index.values[0]))
    dates_dict['train_end'].append(str(train_df.index.values[-1]))
