...
signals_dir = 'outputs/seed_test_momentum_09_rbm_GC_2019_2022_30min_21_09_2022/'
best_signals = 'outputs/seed_test_momentum_09_rbm_GC_2019_2022_30min_21_09_2022/9_signals_GC_2019_2022_30min_train_window8800forward_window440_patch42.csv'
timeframe = 30
...
def do_backtest(test_df, verbose=False):
    ...
    stats = bt.run(clearing=True, time_frame=timeframe)
    if verbose:
        bt.plot()
        print(stats[:27])
    return stats
...
def many_graphs(folder_path, best_experiment_path):
    df_list = []
    signals_df_list = []
...
many_graphs(signals_dir, best_signals)