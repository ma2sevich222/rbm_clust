...
out_data_root = f"Birch_rbm_{source_file_name[:-4]}_{date_xprmnt}"
...
def objective(trial):
    ...
    for n in range(n_iters):
        ...
        features_labels = BRCH.fit_predict(feature_set)
        ...
        for forward_array in Forward_X:
            ...
            pred = BRCH.predict(trnsfrmd_forward_array.reshape(1, -1).astype(float))
