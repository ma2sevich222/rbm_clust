...
out_data_root = f"spectral_rbm_{source_file_name[:-4]}_{date_xprmnt}"
...
def objective(trial):
    ...
    for n in range(n_iters):
        ...
        for forward_array in Forward_X:
            ...
            spec_cl = SpectralClustering(n_clusters=2, assign_labels='discretize',random_state=0).fit(feature_set)
